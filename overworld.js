...
// ----- skill card 1  ------
// //name
const skillCard1 = document.querySelector("#sc1");
skillCard1.innerHTML = skills.One.name;

// ----- skill card 2  ------
//name
const skillCard2 = document.querySelector("#sc2");
skillCard2.innerHTML = skills.Two.name;
